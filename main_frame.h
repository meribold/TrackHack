...
class MainFrame : public wxFrame, public wxThreadHelper
{
	...
	// construct a platform-dependant wxBitmap for drawing it quickly and efficiently to a device context
	// from the bitmap (back ends representation) at the provided position;
	// I found wxBitmap to store at least RGB data on MSW and take no advantage of grayscale images
	...
	void onTrackeeBoxDeleted(wxCommandEvent&);  // process a myEVT_COMMAND_TRACKEEBOX_DELETED
	...
	void onSlider(wxCommandEvent&);          // process a wxEVT_COMMAND_SLIDER_UPDATED; generated after any change
	                                         // of the sliders position in addition to a wxScrollEvent
